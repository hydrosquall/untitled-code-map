...
# https://github.com/Wattenberger/Wattenberger-2019/blob/master/src/components/Articles/ReactRepo/folder_structure_to_json.py
# TODO: rewrite this with nodegit to prevent need for separate pip dependency
...
# TODO: only calculate repository field once, and optionally to avoid bottlenecking on large projects.
...
def path_hierarchy(path):
    ...
    try:
        hierarchy['children'] = [
            ...
            if contents != 'node_modules' and contents != '.git' # hardcode these to prevent a bottleneck
        ]
    except OSError as e:
